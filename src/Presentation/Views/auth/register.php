...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        loginForm.addEventListener('submit', async function(e) {
            ...
            // Send login code and redirect to verify page
            try {
                ...
                if (response.ok) {
                    window.location.href = `${basePath}/auth/verify?type=login&email=${encodeURIComponent(email)}`;
                } else {
        ...
        registerForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (response.ok) {
                    window.location.href = `${basePath}/auth/verify?type=signup&email=${encodeURIComponent(email)}&password=${encodeURIComponent(password)}&name=${encodeURIComponent(name)}`;
                } else {
